        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    String sql = "select u.u_account,u.u_password,u_name,ut.ut_type,u.u_id,u.g_id,u.u_email,u.ut_id,u.station_id from [User] u,usertype ut where u.ut_id = ut.ut_id and u_account = N'" + userName + "'";//查询语句                    
                    ...
                    if (ds != null || (ds.Tables.Count == 0) || (ds.Tables.Count == 1 && ds.Tables[0].Rows.Count == 0))
                    {
                        ...
                        if (userName.Equals(u_account) && userPassword.Equals(u_password) && userType.Equals(u_type))
                        {
                            ...
                            Model.User.ut_id = ut_id;
                            Model.User.station_id = station_id;
                            main1.Owner = this;
                            main1.Show();
                            Hide();
                        }
