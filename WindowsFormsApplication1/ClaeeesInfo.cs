...
namespace WindowsFormsApplication1
{
    public partial class ClaeeesInfo : CCSkinMain
    {
        ...
        private void ClaeeesInfo_Load(object sender, EventArgs e)
        {
            ...
            String sql = "select c.c_name,u.u_name,c.c_introduction,c.c_file,c.c_credit,c.c_recommendTime,c.c_ifExam from [User] u,Classes c where c.u_id = u.u_id and c_id = " + c_id +"";
