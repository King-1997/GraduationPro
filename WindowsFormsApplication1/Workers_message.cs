    ...
    public partial class Workers_message : CCSkinMain
    {
        ...
        private void Wm_btnUpDate_Click(object sender, EventArgs e)
        {
               ...
               MessageBoxIcon.Question) == DialogResult.OK)
            {
                ...
                string sql = "update [User] set u_name = N'" + Wm_tbxUserName.Text + "',ut_id =" + ut_id + " ,g_id = " + g_id + ",station_id = " + station_id + ",u_account = '" + Wm_tbxAccount.Text + "',u_sex = N'" + sex + "',u_idNum = '" + Wm_tbxIDNum.Text + "',u_phone = '" + Wm_tbxPhone.Text + "', u_entryTime = '" + Wm_dtpEntryTime.Value + "' where u_id = " + u_id;
